...
%       output.D_select
    ...
    output.A_gr_inc = A;
    output.A_gr_inc(A > 3) = A(A > 3) + 1;
    output.A_gr_inc = [output.A_gr_inc, ones([size(output.A_gr_inc,1), 1])];
